...
\caption{Graph G=(V, E)}
\end{figure}
Der Ansatzt von unserem Kommilitonen würde in diesem Beispiel als Schnitt entweder $(\{1\}, V \backslash \{1\})$ oder
$(\{2\}, V \backslash \{2\})$ liefern (da dies die beiden Knoten mit höchstem Grad sind). In diesem
